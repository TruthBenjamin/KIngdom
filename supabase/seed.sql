...
VALUES 
  ...
  ('e390f1ee-6c54-4b01-90e6-d701748f0852', 'Sermon Series Graphic Pack', 'sermon-graphics-pack', 'Custom visual identity for your next sermon series. Includes title slide and social promo graphics.', 'Brand Design', 'brand-design', 15000, 5, 2, 'Send the series title, scripture/theme notes, schedule, and required output sizes.', 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=1200&h=900&fit=crop', ARRAY['https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&h=900&fit=crop'], ARRAY['sermon series','slides','social graphics'], false, 'active', 'active'),
  ('f490f1ee-6c54-4b01-90e6-d701748f0853', 'Custom Church Website (Next.js)', 'church-web-nextjs', 'A high-performance website for your ministry. Built with Next.js and SEO optimized.', 'Web Development', 'web-development', 120000, 30, 5, 'Send sitemap, brand assets, page copy, integration needs, and domain notes.', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=900&fit=crop', ARRAY['https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=900&fit=crop'], ARRAY['nextjs','church website','seo'], true, 'active', 'active'),
